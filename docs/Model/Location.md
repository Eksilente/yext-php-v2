...
**state** | **string** | The two-character state code, or DC for the District of Columbia | [optional] 
**zip** | **string** | The five- or nine-digit ZIP code (the hyphen is optional) | [optional] 
**country_code** | **string** | The country code (two-character ISO 3166-1) of the location&#39;s country . US is the only valid value. | [optional] 
**service_area** | [**\Yext\Client\Model\LocationServiceArea**](LocationServiceArea.md) |  | [optional] 
**phone** | **string** | Must be a valid 10-digit phone number. | [optional] 
...
**local_phone** | **string** | Must be a valid, non-toll-free 10-digit phone number.  Required if: * **isPhoneTracked** is true and the non-tracked number is a toll-free number, **OR** * **isPhoneTracked** is false and **phone** is a toll-free number | [optional] 
**alternate_phone** | **string** | Must be a valid 10-digit phone number. Phone numbers for US locations must contain 10 digits. | [optional] 
**fax_phone** | **string** | Must be a valid 10-digit phone number. Phone numbers for US locations must contain 10 digits. | [optional] 
**mobile_phone** | **string** | Must be a valid 10-digit phone number. Phone numbers for US locations must contain 10 digits. | [optional] 
**toll_free_phone** | **string** | Must be a valid 10-digit phone number. Phone numbers for US locations must contain 10 digits. | [optional] 
...
**payment_options** | **string[]** | The payment methods accepted at this location  Valid elements depend on the location&#39;s country. For US locations, valid elements are: * AMERICANEXPRESS * CASH * CHECK * DINERSCLUB * DISCOVER * FINANCING * INVOICE * MASTERCARD * TRAVELERSCHECK * VISA | [optional] 
...
**display_lat** | **double** | Longitude where the map pin should be displayed, as provided by you  Between -180.0 and 180.0, inclusive | [optional] 
**routable_lat** | **double** | Longitude to use for driving directions to the location, as provided by you  Between -180.0 and 180.0, inclusive | [optional] 
**yext_display_lat** | **double** | Longitude where the map pin should be displayed, as calculated by Yext  Between -180.0 and 180.0, inclusive | [optional] 
**yext_routable_lat** | **double** | Longitude to use for driving directions to the location, as calculated by Yext  Between -180.0 and 180.0, inclusive | [optional] 
...
**product_lists_label** | **string** | Services lists. | [optional] 
...
**label_ids** | **string[]** | The IDs of the location labels that have been added to this location.  **NOTE:** You can only add labels that have already been created via our web interface. Currently, it is not possible to create new labels via the API. | [optional] 
