...
class AnalyticsApi
{
    ...
    public function activityLogWithHttpInfo($account_id, $body = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Yext\Client\Model\InlineResponse200', $httpHeader), $statusCode, $httpHeader];
    ...
    public function createReportsWithHttpInfo($account_id, $async = null, $callback = null, $body = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Yext\Client\Model\InlineResponse2002', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getMaxDatesWithHttpInfo($account_id)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Yext\Client\Model\InlineResponse2001', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function reportStatusWithHttpInfo($account_id, $report_id)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Yext\Client\Model\InlineResponse2003', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
