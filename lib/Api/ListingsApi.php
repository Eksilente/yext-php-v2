...
class ListingsApi
{
    ...
    public function listListingsWithHttpInfo($account_id, $v, $limit = null, $offset = null, $location_ids = null, $publisher_ids = null)
    {
        ...
        if ($limit > 1000.0) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ListingsApi.listListings, must be smaller than or equal to 1000.0.');
        }
    ...
    public function listPublisherSuggestionsWithHttpInfo($account_id, $v, $limit = null, $offset = null, $location_ids = null, $publisher_ids = null, $statuses = null)
    {
        ...
        if ($limit > 50.0) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ListingsApi.listPublisherSuggestions, must be smaller than or equal to 50.0.');
        }
