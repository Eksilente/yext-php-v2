...
class Activity implements ArrayAccess
{
    ...
    /**
     * Sets type
     * @param string $type The type of the activity.  See AnalyticsFilter for activity types.
     * @return $this
     */
    ...
    /**
     * Sets date
     * @param string $date The date and time the activity occurred in ISO 8601 format (yyyy-mm-ddT:hh:mm:ss.000Z)
     * @return $this
     */
