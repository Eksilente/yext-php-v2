...
class BaseEcl implements ArrayAccess
{
    ...
    /**
     * Sets account_id
     * @param string $account_id ID of account that owns this ECL.
     * @return $this
     */
    ...
    /**
     * Sets title
     * @param string $title ECL title that appears on listings
     * @return $this
     */
    ...
    /**
     * Sets size
     * @param int $size Number of items in the ECL
     * @return $this
     */
