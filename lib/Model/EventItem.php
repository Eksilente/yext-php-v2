...
class EventItem implements ArrayAccess
{
    ...
    /**
     * Sets ends
     * @param \DateTime $ends End time in ISO 8601 format (yyyy-mm-ddThh:mm) (e.g., 2012-01-09T5:00).
     * @return $this
     */
    ...
    /**
     * Sets starts
     * @param \DateTime $starts Start time in ISO 8601 format (yyyy-mm-ddThh:mm) (e.g., 2012-01-09T4:00).
     * @return $this
     */
