...
/**
 * InlineResponse2014Response Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Yext\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2014Response implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_4_response';
    ...
    /**
     * Sets id
     * @param string $id ID of new PostEntry object
     * @return $this
     */
